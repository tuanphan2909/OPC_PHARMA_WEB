...
namespace web4.Controllers
{
    public class FormBKNopTienController : Controller
    {
        ...
        public List<BangKeNopTien> UpdateLoadHD()
        {
            string ma_dvcs = Request.Cookies["MA_DVCS"] != null ? Request.Cookies["MA_DVCS"].Value : "";
                        ...
                        if (ds.Tables.Count > 0)
                        {
                            ...
                            foreach (DataRow row in dt.Rows)
                            {
                                BangKeNopTien dataItem = new BangKeNopTien
                                {
                                    ...
                                    So_BK = row["so_ct"].ToString(),
                                    Ngay_HD = row["Ngay_Ct"].ToString(),
                                    So_HD = row["So_Hd"].ToString(),
                                    Ma_Dt = row["Ma_Dt"].ToString(),
                                    Ten_Dt = row["Ten_Dt"].ToString(),
                                    Tien_HD = float.Parse(row["Tien_Truoc_Thue"].ToString())
        ...
        public ActionResult InsertBangKe1()
        {
            List<BangKeNopTien> dmDlistTDV = LoadData.LoadDmTDVBK(Request);
        ...
        public ActionResult InsertBangKeLoadHD1()
        {
            List<BangKeNopTien> dmDlistTDV = LoadData.LoadDmTDVBK(Request);
            List<BangKeNopTien> dmListHD = LoadHD();
            ViewBag.DataTDV = dmDlistTDV;
            ...
            if (BK != null && BK.Details != null)
            {
                try
                {
                    ...
                    using (var connection = new SqlConnection(con.ConnectionString))
                    {
                        ...
                        using (var command = new SqlCommand("InsertBangKeNopTien1", connection))
                        {
                            command.CommandType = CommandType.StoredProcedure;
                            ...
                            detailsParam.TypeName = "B30BKNTdetailType2"; // Replace with your actual type name
        ...
        public ActionResult MauInBangKe()
        {
            ...
            string Pname = "BangKeNopTien_SAP";
        ...
        public ActionResult UpdateBangKe1()
        {
            List<BangKeNopTien> dmDlistTDV = LoadData.LoadDmTDVBK(Request);
            List<BangKeNopTien> dmListHD = LoadHDUpdate();
            ViewBag.DataTDV = dmDlistTDV;
        ...
        public ActionResult UpdateBangKeLoadHD()
        {
            List<BangKeNopTien> dmDlistTDV = LoadData.LoadDmTDVBK(Request);
            List<BangKeNopTien> dmListHD = LoadHDUpdate();
            ViewBag.DataTDV = dmDlistTDV;
        ...
        public ActionResult UpdateBangKeLoadHD1()
        {
            List<BangKeNopTien> dmDlistTDV = LoadData.LoadDmTDVBK(Request);
            List<BangKeNopTien> dmListHD = LoadHDUpdate();
            ViewBag.DataTDV = dmDlistTDV;
            ...
            if (BK != null && BK.Details != null)
            {
                try
                {
                    ...
                    using (var connection = new SqlConnection(con.ConnectionString))
                    {
                        ...
                        using (var command = new SqlCommand("UpdateBangKeNopTien", connection))
                        {
                            command.CommandType = CommandType.StoredProcedure;
        ...
        public ActionResult Delete(BangKeNopTien BK)
        {
            ...
            try
            {
                using (var connection = new SqlConnection(con.ConnectionString))
                {
                    ...
                    using (var command = new SqlCommand("Delete_BangKeNopTien", connection))
                    {
                        command.CommandType = CommandType.StoredProcedure;
