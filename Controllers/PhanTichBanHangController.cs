...
namespace web4.Controllers
{
    public class PhanTichBanHangController : Controller
    {
        ...
        public List<MauInChungTu> LoadDmSalesUnit()
        {
            connectSQL();
                ...
                using (SqlCommand command = new SqlCommand("[usp_DanhMucSalesUnit_SAP]", connection))
                {
                    ...
                    using (SqlDataReader reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            {
                                Ma_Unit = reader["Ma_Unit"].ToString(),
                                Ten_Sales_Unit = reader["Ten_Sales_Unit"].ToString()
        ...
        public ActionResult PhanTichBanHang_Fill()
        {
            ...
            List<MauInChungTu> dmDlistSU = LoadDmSalesUnit();

            ViewBag.DataItemsSU = dmDlistSU;
        ...
        public ActionResult PhanTichBanHang(Account Acc)
        {
           ...
           var Unit = Request.Cookies["Ma_Unit"].Value;
            if(Dvcs == "OPC_B1")
            {
                Dvcs = "OPC";
            }
            ...
            using (SqlCommand cmd = new SqlCommand(Pname, con))
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
                    ...
                    cmd.Parameters.AddWithValue("@_SaleUnit", Unit);
