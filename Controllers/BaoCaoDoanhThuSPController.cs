...
{
    public class BaoCaoDoanhThuSPController : Controller
    {
        // GET: BaoCaoDoanhThuSP
        SqlConnection con = new SqlConnection();
 
     
        public ActionResult BaoCaoDoanhThuSP_Fill()
        {
            return View();
        }
        public ActionResult BaoCaoDoanhThuSP()
        {
            ...
            string Pname = "[usp_BaoCaoDoanhThuSP_SAP]";
