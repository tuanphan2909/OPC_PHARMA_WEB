...
{
    public class BaoCaoDoanhThuETCController : Controller
    {
        // GET: BaoCaoMAR
        SqlConnection con = new SqlConnection();
        public ActionResult BaoCaoDoanhThuETC_Fill()
        {
            return View();
        }
        public ActionResult BaoCaoDoanhThuETC()
        {
            ...
            string Pname = "[usp_BaoCaoDoanhThuAOP_ETC_SAP]";
