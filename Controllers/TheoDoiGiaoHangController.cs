...
namespace web4.Controllers
{
    public class TheoDoiGiaoHangController : Controller
    {
        ...
        public List<TheoDoiGiaoHang> LoadHD()
        {
            ...
            string TuNgay = Request.Cookies["Tu_Ngay"] != null ? Request.Cookies["Tu_Ngay"].Value : "";
            string DenNgay = Request.Cookies["Den_Ngay"] != null ? Request.Cookies["Den_Ngay"].Value : "";
            connectSQL();
            ...
            using (SqlConnection connection = new SqlConnection(con.ConnectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand("[usp_DanhSachHoaDonGiaoHang_SAP]", connection))
                {
                    ...
                    command.Parameters.AddWithValue("@_Tu_Ngay", TuNgay);
                    command.Parameters.AddWithValue("@_Den_Ngay", DenNgay);
        ...
        public ActionResult SaveHD(TheoDoiGiaoHang TDGH)
        {
            ...
            if (TDGH != null && TDGH.Details != null)
            {
                try
                {
                    ...
                    detailsTable.Columns.Add("Nop_Tien_Mat", typeof(bool));
                    foreach (var detail in TDGH.Details)
                    {
                        detailsTable.Rows.Add(detail.So_Hd, detail.Ngay_HD, detail.Ma_Dt, detail.Ten_Dt, detail.NV_GiaoNhan, detail.Giao_HD, detail.Tien_HD,detail.Tien_Phai_Thu, detail.Noi_Dung, detail.Chua_giao_hang, detail.Nop_Tien_Mat);
                    }
                    ...
                    using (var connection = new SqlConnection(con.ConnectionString))
                    {
                        ...
                        using (var command = new SqlCommand("InsertTheoDoiGiaoHang2_SAP", connection))
                        {
                            command.CommandType = CommandType.StoredProcedure;
                            ...
                            detailsParam.TypeName = "B30GdetailType2"; // Replace with your actual type name
        ...
        public ActionResult PhieuDieuPhoiGH_In()
        {
            DataSet ds = new DataSet();
            connectSQL();
        ...
        public ActionResult Delete(TheoDoiGiaoHang GH)
        {
            ...
            try
            {
                using (var connection = new SqlConnection(con.ConnectionString))
                {
                    ...
                    using (var command = new SqlCommand("Delete_TheoDoiGiaoHang", connection))
                    {
                        command.CommandType = CommandType.StoredProcedure;

                        command.Parameters.AddWithValue("@_STT", GH.Stt);
